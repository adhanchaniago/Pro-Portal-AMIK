                            ...
                            <tbody>
                                <?php foreach ($admins as $no => $row) : ?>
                                    <tr>
                                        ...
                                        <td width="110px">
                                            <a href="<?= site_url('Admin/' . $row->admin_id); ?>" class="btn btn-warning btn-sm">Edit</a>
                                            <a href="<?= site_url('Admin/Delete/' . $row->admin_id); ?>" class="btn btn-danger btn-sm">Hapus</a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
