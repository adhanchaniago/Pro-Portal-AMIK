            ...
            <section class="content container-fluid">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form method="POST" action="<?= site_url('Dosen/Add'); ?>">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>NIDN</label>
                                        <input required type="text" class="form-control" name="nidn" placeholder="NIDN">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="date" class="form-control" name="msk" placeholder="Tanggal Masuk">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                    ...
                                    <div class="form-group">
                                        <label>No Hp</label>
                                        <input required type="number" class="form-control" name="nohp" placeholder="No HP">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
