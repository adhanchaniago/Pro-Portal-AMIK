                            ...
                            <tbody>
                                <?php foreach ($Penelitians as $no => $row) : ?>
                                    <tr>
                                        ...
                                        <td width="160px">
                                            <a href="<?= site_url('Penelitian/Detail/' . $row->penelitian_id); ?>" class="btn btn-success btn-sm">Detail</a>
                                            <a href="<?= site_url('Penelitian/' . $row->penelitian_id); ?>" class="btn btn-warning btn-sm">Edit</a>
                                            <a href="<?= site_url('Penelitian/Delete/' . $row->penelitian_id); ?>" class="btn btn-danger btn-sm">Hapus</a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
