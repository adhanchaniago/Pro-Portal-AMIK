               ...
               <div class="row align-items-center">
                    <div class="col-lg-7">
                         <div class="row clock_sec clockdiv" id="clockdiv">
                              <div class="col-lg-12">
                                   ...
                                   <p>
                                        Hanya dosen AMIK Daparnas yang dapat melakukan login, jika ada belum memiliki akun silahkan hubungi administrator.
                                   </p>
                              </div>
                         </div>
                    </div>
                    <div class="col-lg-4 offset-lg-1">
                         <div class="register_form">
                              ...
                              <form action="<?= site_url('LoginDosen'); ?>" method="post">
                                   <div class="row">
                                        <form action="<?= site_url('LoginDosen'); ?>" method="POST">
                                             <div class="col-lg-12 form_group">
                                                  <input name="nidn" placeholder="Your NIDN" required type="number" />
